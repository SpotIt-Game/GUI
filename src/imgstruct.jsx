class imgStruct {
    constructor(url, rotation, scale, x, y, width, height) {
        ...
        this.styler = {
            ...
            top: `${this.y + 250 - (this.height * Math.sqrt(this.scale)) / 2}px`, // Adjusted to center vertically
            left: `${this.x + 250 - (this.width * Math.sqrt(this.scale)) / 2}px`, // Adjusted to center horizontally
